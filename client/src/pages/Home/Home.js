          ...
          <Carousel.Item>
            <Row className="justify-content-md-center">
              <Col sm={3} md="auto" className="mx-auto students">
                <Image src={IITJEE1} className="FeedbackImg" roundedCircle style={{height: "25px", width: "25px"}} />
              ...
              <Col sm={3} md="auto" className="mx-auto students">
                <Image src={UPSC1} className="FeedbackImg" roundedCircle style={{height: "25px", width: "25px"}}/>
                <h2>Dhruv Mittal</h2>
                <p className="text-wrap" style={{ width: "15rem" }}>
              ...
              <Col sm={3} md="auto" className="mx-auto students">
                <Image src={NEET1} className="FeedbackImg" roundedCircle style={{height: "25px", width: "25px"}}/>
